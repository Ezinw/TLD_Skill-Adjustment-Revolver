...
namespace SkillAdjustmentRevolver
{
    ...
    internal class RevolverAdjustmentXP
    {
        public static void Postfix(SkillsManager __instance)
        {
            ...
            {
                 revolverSkill.m_TierPoints[1] = Settings.settings.tier2;
                 revolverSkill.m_TierPoints[2] = Settings.settings.tier3;
                 revolverSkill.m_TierPoints[3] = Settings.settings.tier4;
                 revolverSkill.m_TierPoints[4] = Settings.settings.tier5;
            }
        }
    }
