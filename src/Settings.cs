...
namespace SkillAdjustmentRevolver
{
    internal class Settings : JsonModSettings
    {
        ...
        internal void RefreshFields()
        {
            ...
            SetFieldVisible(nameof(tier2), revolver2 && Revolver);
            ...
            SetFieldVisible(nameof(tier3), revolver3 && Revolver);
            ...
            SetFieldVisible(nameof(tier4), revolver4 && Revolver);
            ...
            SetFieldVisible(nameof(tier5), revolver5 && Revolver);
